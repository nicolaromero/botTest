...
# Obtener precio de punta en las órdenes de tipo "Bid"
    ...
    precio_punta_compra = float(bids[4][0])
...
# Obtener mis órdenes pendientes
    ...
    if not orders:
        ...
        new_price = precio_punta_compra + 1
        max_price = precio_punta_venta - (spread / 2)
        print("Nuevo precio: ", new_price)
        print("Maximo precio: ", max_price)
        if new_price <= max_price:
            # Realizar cálculos con el balance y cantidad
            # ...
            ...
            print("Nueva orden de compra:", response_newOrder.json())
    else:
